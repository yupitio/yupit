...
class ContactHelpMeBusiness extends Component{
  ...
  render (){
    ...
    return(
      <>
     <div onClick={() => this.handleModalOpen()} className="btn btn-success text-center">Help Me</div>
            ...
            <div className="">
              ...
              <div className="row">
                  ...
                  <div className="col-md-12 mb-4 text-center">
                      <button disabled={this.state.IsSubmit} type="button" onClick={this.submitForm} className="btn btn-success">
