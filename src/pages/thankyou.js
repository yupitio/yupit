...
import thankYouImage from "../img/thank-you.svg";
const thankyoupage = () => (
  ...
  <Layout>
      ...
      <section className="thank-you-page-section">
        <div className="container text-center">
          <div className="row justify-content-center">
            <div className="col-xl-12">
              <img src={thankYouImage} className="d-inline img-fluid mb-4" alt=""/>
              <h1 className="section-heading-1 font-weight-bold mb-2">Thank You</h1>
              <p className="sub-heading"> for reaching out to us</p>
